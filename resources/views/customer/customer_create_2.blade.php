...
@section('title','Customer Tambah 2')
...
@endsection
@section('header','Customer Tambah 2')
@section('konten')
<!-- Content Body place -->
<!-- SELECT2 EXAMPLE -->
<div class="container">
    <div class="card card-default">
        <div class="card-header">
            <h3 class="card-title">Tambah Customer(File Path image)</h3>
        ...
        @if (session('status'))
                ...
                @endif
            <form action="{{ url('customer-tambah2/store') }}" method="post" enctype="multipart/form-data">
            {{ csrf_field() }}
                <div class="row">
                    <div class="col-md-6">
